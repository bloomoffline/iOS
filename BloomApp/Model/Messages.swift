...
fileprivate let log = Logger(label: "BloomApp.Messages")
...
class Messages: ObservableObject {
    ...
    private func storeLocally(attachment: ChatAttachment) -> ChatAttachment {
        ...
        let baseURL = URL(string: "bloomoffline:///attachment/\(attachment.name.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed)!)")!
