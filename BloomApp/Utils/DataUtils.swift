...
fileprivate let log = Logger(label: "BloomApp.DataUtils")
...
extension Data {
    /// Reads a potentially security-scoped or Bloom-schemed resource.
    ...
    /// Writes a potentially Bloom-schemed resources.
